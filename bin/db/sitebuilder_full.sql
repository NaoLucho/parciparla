...
-- Généré le :  Mar 12 Juin 2018 à 11:06
...
INSERT INTO `carousel` (`id`, `title`, `content`, `image_name`, `image_size`, `updated_at`) VALUES
(1, 'zezfzd', 'fezfd', '5b0e85af8c818_index.png', 4011, '2018-05-30 13:06:23');
...
(3, NULL, NULL, 'louis', 'PAS D\'accord!', 'azdiozadoizdaziodn', '2018-06-12 09:21:53', NULL, 0),
(4, NULL, NULL, 'louis', 'PAS D\'accord!', 'azdiozadoizdaziodn', '2018-06-12 09:22:36', NULL, 0),
...
--
-- Structure de la table `program_results`
--
...
--
-- Structure de la table `p_geom_localisation`
--

CREATE TABLE `p_geom_localisation` (
...
--
-- Structure de la table `p_members_structures`
--

CREATE TABLE `p_members_structures` (
  `user_id` int(11) NOT NULL,
  `p_structure_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Structure de la table `p_program`
--

CREATE TABLE `p_program` (
  `id` int(11) NOT NULL,
  `li_status` int(11) DEFAULT NULL,
  `li_accessibility` int(11) DEFAULT NULL,
  `structure_anim` int(11) DEFAULT NULL,
  `structure_resp_scientist` int(11) DEFAULT NULL,
  `user_contact_resp_scientist` int(11) DEFAULT NULL,
  `li_network_obs` int(11) DEFAULT NULL,
  `li_program_duration` int(11) DEFAULT NULL,
  `li_suscriber_duration_moy` int(11) DEFAULT NULL,
  `li_program_quality_evolution` int(11) DEFAULT NULL,
  `li_program_data_validator` int(11) DEFAULT NULL,
  `li_program_data_analyser` int(11) DEFAULT NULL,
  `li_program_data_format` int(11) DEFAULT NULL,
  `li_protocol_sinp` int(11) DEFAULT NULL,
  `li_program_annual_budget` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `logo_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `logo_size` int(11) NOT NULL,
  `photo_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `photo_size` int(11) DEFAULT NULL,
  `video_link` varchar(1024) COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` longtext COLLATE utf8_unicode_ci NOT NULL,
  `stuff` longtext COLLATE utf8_unicode_ci NOT NULL,
  `anecdote` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
  `website_URL` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `start_op_year` int(11) DEFAULT NULL,
  `others_indicators` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `data_feedback` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `data_storage_localisation` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `nb_etp` int(11) DEFAULT NULL,
  `nb_working_persons` int(11) DEFAULT NULL,
  `financePartners` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `isFinalizedForm` tinyint(1) NOT NULL,
  `isActiveProgram` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Structure de la table `p_program_objective`
--

CREATE TABLE `p_program_objective` (
  `id` int(11) NOT NULL,
...
--
-- Structure de la table `p_program_seasons`
--

CREATE TABLE `p_program_seasons` (
  `p_program_id` int(11) NOT NULL,
  `g_list_item_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Structure de la table `p_program_structure_relay_local`
--

CREATE TABLE `p_program_structure_relay_local` (
  `p_program_id` int(11) NOT NULL,
  `p_structure_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Structure de la table `p_program_taxons`
--

CREATE TABLE `p_program_taxons` (
  `p_program_id` int(11) NOT NULL,
  `g_list_item_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Structure de la table `p_program_themes`
--

CREATE TABLE `p_program_themes` (
  `p_program_id` int(11) NOT NULL,
  `g_list_item_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Structure de la table `p_program_user_owner_anim`
--

CREATE TABLE `p_program_user_owner_anim` (
  `p_program_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Structure de la table `p_program_valuebyyear`
--

CREATE TABLE `p_program_valuebyyear` (
  `id` int(11) NOT NULL,
  `program_id_subscriber` int(11) DEFAULT NULL,
  `program_id_activeuser` int(11) DEFAULT NULL,
  `program_id_collecteddata` int(11) DEFAULT NULL,
...
--
-- Structure de la table `p_skills`
--
...
--
-- Structure de la table `p_structure`
--

CREATE TABLE `p_structure` (
  `id` int(11) NOT NULL,
  `li_structure_type` int(11) DEFAULT NULL,
  `owner` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `isActive` tinyint(1) NOT NULL,
  ...
  `image_size` int(11) NOT NULL,
  `updated_at` datetime DEFAULT NULL,
  `isPorteur` tinyint(1) NOT NULL,
  `isRelai` tinyint(1) NOT NULL,
  `isCollectifCoordo` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Structure de la table `p_users_skills`
--

CREATE TABLE `p_users_skills` (
  `user_id` int(11) NOT NULL,
...
--
-- Structure de la table `p_users_taxons`
--

CREATE TABLE `p_users_taxons` (
  `user_id` int(11) NOT NULL,
  `g_list_item_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Structure de la table `p_users_themes`
--

CREATE TABLE `p_users_themes` (
  `user_id` int(11) NOT NULL,
  `g_list_item_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `partners`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_EFEB516492ED7784` (`program`);

--
-- Index pour la table `program_results`
--
ALTER TABLE `program_results`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_14491CC092ED7784` (`program`);

--
-- Index pour la table `p_geom_localisation`
--
ALTER TABLE `p_geom_localisation`
  ADD PRIMARY KEY (`p_program_id`,`geom_id`),
  ADD KEY `IDX_1795083569EB0105` (`p_program_id`),
  ADD KEY `IDX_17950835C06AE09C` (`geom_id`);

--
-- Index pour la table `p_members_structures`
--
ALTER TABLE `p_members_structures`
  ADD PRIMARY KEY (`user_id`,`p_structure_id`),
  ADD KEY `IDX_462AF98DA76ED395` (`user_id`),
  ADD KEY `IDX_462AF98D4BCFEE22` (`p_structure_id`);

--
-- Index pour la table `p_program`
--
ALTER TABLE `p_program`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_952D9EEB8CA5806F` (`li_status`),
  ADD KEY `IDX_952D9EEB35E7AC95` (`li_accessibility`),
  ADD KEY `IDX_952D9EEBD6B11679` (`structure_anim`),
  ADD KEY `IDX_952D9EEBD575B4D6` (`structure_resp_scientist`),
  ADD KEY `IDX_952D9EEBEF713329` (`user_contact_resp_scientist`),
  ADD KEY `IDX_952D9EEB15786682` (`li_network_obs`),
  ADD KEY `IDX_952D9EEB29C16B75` (`li_program_duration`),
  ADD KEY `IDX_952D9EEBCB6122F2` (`li_suscriber_duration_moy`),
  ADD KEY `IDX_952D9EEB9E84EF81` (`li_program_quality_evolution`),
  ADD KEY `IDX_952D9EEBEFB5283C` (`li_program_data_validator`),
  ADD KEY `IDX_952D9EEB161405F7` (`li_program_data_analyser`),
  ADD KEY `IDX_952D9EEBD7ECEBF6` (`li_program_data_format`),
  ADD KEY `IDX_952D9EEB89C296DC` (`li_protocol_sinp`),
  ADD KEY `IDX_952D9EEBD30A92B9` (`li_program_annual_budget`);

--
-- Index pour la table `p_program_objective`
--
ALTER TABLE `p_program_objective`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_E6DC112A3EB8070A` (`program_id`),
  ADD KEY `IDX_E6DC112A73484933` (`objective_id`);

--
-- Index pour la table `p_program_seasons`
--
ALTER TABLE `p_program_seasons`
  ADD PRIMARY KEY (`p_program_id`,`g_list_item_id`),
  ADD KEY `IDX_3255BBF69EB0105` (`p_program_id`),
  ADD KEY `IDX_3255BBFA3A4F756` (`g_list_item_id`);

--
-- Index pour la table `p_program_structure_relay_local`
--
ALTER TABLE `p_program_structure_relay_local`
  ADD PRIMARY KEY (`p_program_id`,`p_structure_id`),
  ADD KEY `IDX_6E7EF06C69EB0105` (`p_program_id`),
  ADD KEY `IDX_6E7EF06C4BCFEE22` (`p_structure_id`);

--
-- Index pour la table `p_program_taxons`
--
ALTER TABLE `p_program_taxons`
  ADD PRIMARY KEY (`p_program_id`,`g_list_item_id`),
  ADD KEY `IDX_36664A3669EB0105` (`p_program_id`),
  ADD KEY `IDX_36664A36A3A4F756` (`g_list_item_id`);

--
-- Index pour la table `p_program_themes`
--
ALTER TABLE `p_program_themes`
  ADD PRIMARY KEY (`p_program_id`,`g_list_item_id`),
  ADD KEY `IDX_7975AAA069EB0105` (`p_program_id`),
  ADD KEY `IDX_7975AAA0A3A4F756` (`g_list_item_id`);

--
-- Index pour la table `p_program_user_owner_anim`
--
ALTER TABLE `p_program_user_owner_anim`
  ADD PRIMARY KEY (`p_program_id`,`user_id`),
  ADD KEY `IDX_809C22D969EB0105` (`p_program_id`),
  ADD KEY `IDX_809C22D9A76ED395` (`user_id`);

--
-- Index pour la table `p_program_valuebyyear`
--
ALTER TABLE `p_program_valuebyyear`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_391E088BADC3CB26` (`program_id_subscriber`),
  ADD KEY `IDX_391E088BAEC8A3FE` (`program_id_activeuser`),
  ADD KEY `IDX_391E088B97FFC417` (`program_id_collecteddata`);

--
-- Index pour la table `p_skills`
--
ALTER TABLE `p_skills`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNIQ_781C60745E237E06` (`name`);

--
-- Index pour la table `p_structure`
--
ALTER TABLE `p_structure`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_54B21D9EFD4636D8` (`li_structure_type`),
  ADD KEY `IDX_54B21D9ECF60E67C` (`owner`);

--
-- Index pour la table `p_users_skills`
--
ALTER TABLE `p_users_skills`
  ADD PRIMARY KEY (`user_id`,`skill_id`),
  ADD KEY `IDX_B42D7649A76ED395` (`user_id`),
  ADD KEY `IDX_B42D76495585C142` (`skill_id`);

--
-- Index pour la table `p_users_taxons`
--
ALTER TABLE `p_users_taxons`
  ADD PRIMARY KEY (`user_id`,`g_list_item_id`),
  ADD KEY `IDX_3B4DB271A76ED395` (`user_id`),
  ADD KEY `IDX_3B4DB271A3A4F756` (`g_list_item_id`);

--
-- Index pour la table `p_users_themes`
--
ALTER TABLE `p_users_themes`
  ADD PRIMARY KEY (`user_id`,`g_list_item_id`),
  ADD KEY `IDX_745E52E7A76ED395` (`user_id`),
  ADD KEY `IDX_745E52E7A3A4F756` (`g_list_item_id`);
...
ALTER TABLE `partners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `program_results`
--
ALTER TABLE `program_results`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `p_program`
--
ALTER TABLE `p_program`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `p_program_objective`
--
ALTER TABLE `p_program_objective`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `p_program_valuebyyear`
--
ALTER TABLE `p_program_valuebyyear`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `p_skills`
--
ALTER TABLE `p_skills`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `p_structure`
--
ALTER TABLE `p_structure`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `partners`
  ADD CONSTRAINT `FK_EFEB516492ED7784` FOREIGN KEY (`program`) REFERENCES `p_program` (`id`);

--
-- Contraintes pour la table `program_results`
--
ALTER TABLE `program_results`
  ADD CONSTRAINT `FK_14491CC092ED7784` FOREIGN KEY (`program`) REFERENCES `p_program` (`id`);

--
-- Contraintes pour la table `p_geom_localisation`
--
ALTER TABLE `p_geom_localisation`
  ADD CONSTRAINT `FK_1795083569EB0105` FOREIGN KEY (`p_program_id`) REFERENCES `p_program` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_17950835C06AE09C` FOREIGN KEY (`geom_id`) REFERENCES `geom` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `p_members_structures`
--
ALTER TABLE `p_members_structures`
  ADD CONSTRAINT `FK_462AF98D4BCFEE22` FOREIGN KEY (`p_structure_id`) REFERENCES `p_structure` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_462AF98DA76ED395` FOREIGN KEY (`user_id`) REFERENCES `fos_user_user` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `p_program`
--
ALTER TABLE `p_program`
  ADD CONSTRAINT `FK_952D9EEB15786682` FOREIGN KEY (`li_network_obs`) REFERENCES `g_listitem` (`id`),
  ADD CONSTRAINT `FK_952D9EEB161405F7` FOREIGN KEY (`li_program_data_analyser`) REFERENCES `g_listitem` (`id`),
  ADD CONSTRAINT `FK_952D9EEB29C16B75` FOREIGN KEY (`li_program_duration`) REFERENCES `g_listitem` (`id`),
  ADD CONSTRAINT `FK_952D9EEB35E7AC95` FOREIGN KEY (`li_accessibility`) REFERENCES `g_listitem` (`id`),
  ADD CONSTRAINT `FK_952D9EEB89C296DC` FOREIGN KEY (`li_protocol_sinp`) REFERENCES `g_listitem` (`id`),
  ADD CONSTRAINT `FK_952D9EEB8CA5806F` FOREIGN KEY (`li_status`) REFERENCES `g_listitem` (`id`),
  ADD CONSTRAINT `FK_952D9EEB9E84EF81` FOREIGN KEY (`li_program_quality_evolution`) REFERENCES `g_listitem` (`id`),
  ADD CONSTRAINT `FK_952D9EEBCB6122F2` FOREIGN KEY (`li_suscriber_duration_moy`) REFERENCES `g_listitem` (`id`),
  ADD CONSTRAINT `FK_952D9EEBD30A92B9` FOREIGN KEY (`li_program_annual_budget`) REFERENCES `g_listitem` (`id`),
  ADD CONSTRAINT `FK_952D9EEBD575B4D6` FOREIGN KEY (`structure_resp_scientist`) REFERENCES `p_structure` (`id`),
  ADD CONSTRAINT `FK_952D9EEBD6B11679` FOREIGN KEY (`structure_anim`) REFERENCES `p_structure` (`id`),
  ADD CONSTRAINT `FK_952D9EEBD7ECEBF6` FOREIGN KEY (`li_program_data_format`) REFERENCES `g_listitem` (`id`),
  ADD CONSTRAINT `FK_952D9EEBEF713329` FOREIGN KEY (`user_contact_resp_scientist`) REFERENCES `fos_user_user` (`id`),
  ADD CONSTRAINT `FK_952D9EEBEFB5283C` FOREIGN KEY (`li_program_data_validator`) REFERENCES `g_listitem` (`id`);

--
-- Contraintes pour la table `p_program_objective`
--
ALTER TABLE `p_program_objective`
  ADD CONSTRAINT `FK_E6DC112A3EB8070A` FOREIGN KEY (`program_id`) REFERENCES `p_program` (`id`),
  ADD CONSTRAINT `FK_E6DC112A73484933` FOREIGN KEY (`objective_id`) REFERENCES `g_listitem` (`id`);

--
-- Contraintes pour la table `p_program_seasons`
--
ALTER TABLE `p_program_seasons`
  ADD CONSTRAINT `FK_3255BBF69EB0105` FOREIGN KEY (`p_program_id`) REFERENCES `p_program` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_3255BBFA3A4F756` FOREIGN KEY (`g_list_item_id`) REFERENCES `g_listitem` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `p_program_structure_relay_local`
--
ALTER TABLE `p_program_structure_relay_local`
  ADD CONSTRAINT `FK_6E7EF06C4BCFEE22` FOREIGN KEY (`p_structure_id`) REFERENCES `p_structure` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_6E7EF06C69EB0105` FOREIGN KEY (`p_program_id`) REFERENCES `p_program` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `p_program_taxons`
--
ALTER TABLE `p_program_taxons`
  ADD CONSTRAINT `FK_36664A3669EB0105` FOREIGN KEY (`p_program_id`) REFERENCES `p_program` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_36664A36A3A4F756` FOREIGN KEY (`g_list_item_id`) REFERENCES `g_listitem` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `p_program_themes`
--
ALTER TABLE `p_program_themes`
  ADD CONSTRAINT `FK_7975AAA069EB0105` FOREIGN KEY (`p_program_id`) REFERENCES `p_program` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_7975AAA0A3A4F756` FOREIGN KEY (`g_list_item_id`) REFERENCES `g_listitem` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `p_program_user_owner_anim`
--
ALTER TABLE `p_program_user_owner_anim`
  ADD CONSTRAINT `FK_809C22D969EB0105` FOREIGN KEY (`p_program_id`) REFERENCES `p_program` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_809C22D9A76ED395` FOREIGN KEY (`user_id`) REFERENCES `fos_user_user` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `p_program_valuebyyear`
--
ALTER TABLE `p_program_valuebyyear`
  ADD CONSTRAINT `FK_391E088B97FFC417` FOREIGN KEY (`program_id_collecteddata`) REFERENCES `p_program` (`id`),
  ADD CONSTRAINT `FK_391E088BADC3CB26` FOREIGN KEY (`program_id_subscriber`) REFERENCES `p_program` (`id`),
  ADD CONSTRAINT `FK_391E088BAEC8A3FE` FOREIGN KEY (`program_id_activeuser`) REFERENCES `p_program` (`id`);

--
-- Contraintes pour la table `p_structure`
--
ALTER TABLE `p_structure`
  ADD CONSTRAINT `FK_54B21D9ECF60E67C` FOREIGN KEY (`owner`) REFERENCES `fos_user_user` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `FK_54B21D9EFD4636D8` FOREIGN KEY (`li_structure_type`) REFERENCES `g_listitem` (`id`);

--
-- Contraintes pour la table `p_users_skills`
--
ALTER TABLE `p_users_skills`
  ADD CONSTRAINT `FK_B42D76495585C142` FOREIGN KEY (`skill_id`) REFERENCES `p_skills` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_B42D7649A76ED395` FOREIGN KEY (`user_id`) REFERENCES `fos_user_user` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `p_users_taxons`
--
ALTER TABLE `p_users_taxons`
  ADD CONSTRAINT `FK_3B4DB271A3A4F756` FOREIGN KEY (`g_list_item_id`) REFERENCES `g_listitem` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_3B4DB271A76ED395` FOREIGN KEY (`user_id`) REFERENCES `fos_user_user` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `p_users_themes`
--
ALTER TABLE `p_users_themes`
  ADD CONSTRAINT `FK_745E52E7A3A4F756` FOREIGN KEY (`g_list_item_id`) REFERENCES `g_listitem` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_745E52E7A76ED395` FOREIGN KEY (`user_id`) REFERENCES `fos_user_user` (`id`) ON DELETE CASCADE;
