...
use BuilderBundle\Entity\Page_Content;

/**
 * Content
 *
 * @ORM\Table(name="app_content")
 * @ORM\Entity(repositoryClass="BuilderBundle\Repository\ContentRepository")
 */
class Content
{
    /**
    ...
    /** @ORM\OneToMany(targetEntity="BuilderBundle\Entity\Page_Content", mappedBy="content", orphanRemoval=true) */
