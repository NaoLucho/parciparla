 ...
 * @ORM\Entity(repositoryClass="BuilderBundle\Repository\PageRepository")
 */
class Page
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="BuilderBundle\Entity\Page_Content", mappedBy="page", cascade={"persist"}, orphanRemoval=true)
     ...
     * Add pageContents
     *
     * @param \BuilderBundle\Entity\Menu_Page $pageContents
     *
     * @return Page
     */
    public function addPageContent(\BuilderBundle\Entity\Page_Content $pageContents)
    {
     ...
     * Remove pageContents
     *
     * @param \BuilderBundle\Entity\Page_Content $pageContents
     */
    public function removePageContent(\BuilderBundle\Entity\Page_Content $pageContent)
    {
