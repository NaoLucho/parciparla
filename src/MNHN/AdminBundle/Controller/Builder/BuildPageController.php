<?php
namespace MNHN\AdminBundle\Controller\Builder;
...
class BuildPageController extends Controller
{
    ...
    public function buildPageAction($slug, $id = 0, Request $request)
    {
        ...
        $page = $em->getRepository('MNHNAdminBundle:Page')->findOneBy(array('slug' => $slug));
        ...
        if ($page != null) { //CREATE PAGE CONTENT FROM DATABASE
            ...
            if ($page->getSlug() === "home") {
                $carousel = $em->getRepository('MNHNAdminBundle:Carousel')->findAll();
            }
        } else {
        ...
        $pagetemplate = 'MNHNAdminBundle:BuildPage:buildpage.html.twig';
    ...
    public function buildPageDetailsAction($slug, Request $request)
    {
        ...
        $pageContents = $this->get('doctrine.orm.entity_manager')
            ->getRepository('MNHNAdminBundle:Page_Content')
            ->findBy(array('page' => $page));

        return $this->render('MNHNAdminBundle:BuildPage:pagedetails.html.twig', array(
            'page' => $page,
            'pageContents' => $pageContents
        ));
    }
    ...
    public function buildPageWithTemplateAction($slug = "home", Request $request)
    {
        ...
        $pContents = [];
        $footerContents = [];
        $template = 'MNHNAdminBundle:BuildPage:buildpagetemplated.html.twig';
    ...
    //     $pContents = [];
    //     $footerContents = [];
    //     $template = 'MNHNAdminBundle:BuildPage:buildfullpage.html.twig';
    ...
    //     return $this->render('MNHNAdminBundle:BuildPage:buildmenuPrincipal.html.twig', array(
    //         'menuName' => $menuName,
