 ...
 * @ORM\Entity(repositoryClass="MNHN\AdminBundle\Repository\F_FormFieldRightsRepository")
 */
class F_FormFieldRights
{
    ...
    /**
    * @ORM\ManyToOne(targetEntity="MNHN\AdminBundle\Entity\F_FormField", inversedBy="formfieldrights")
    ...
    */
     ...
     * @return F_FormFieldRights
     */
    public function setFormField(\MNHN\AdminBundle\Entity\F_FormField $formField)
    {
     ...
     * Get formField
     *
     * @return \MNHN\AdminBundle\Entity\F_FormField
     */
