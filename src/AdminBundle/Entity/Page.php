...
class Page
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="AdminBundle\Entity\Page_Content", mappedBy="page", cascade={"persist"}, orphanRemoval=true)
     ...
     * Add pageContents
     *
     * @param \AdminBundle\Entity\Menu_Page $pageContents
     *
     * @return Page
     */
    public function addPageContent(\AdminBundle\Entity\Page_Content $pageContents)
    {
     ...
     * Remove pageContents
     *
     * @param \AdminBundle\Entity\Page_Content $pageContents
     */
    public function removePageContent(\AdminBundle\Entity\Page_Content $pageContent)
    {
