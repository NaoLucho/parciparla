<?php
namespace AdminBundle\Controller\Builder;

use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Symfony\Component\HttpFoundation\Request;
use Doctrine\Common\Collections\Criteria;
use AdminBundle\Controller\Builder\Utils;
...
class BuildPageController extends Controller
{
    ...
    public function buildPageAction($slug, $id = 0, $tab = '', Request $request)
    {
        ...
        if ($page != null) { //CREATE PAGE CONTENT FROM DATABASE
            ...
            if ($page->getSlug() === "home") {
                $carousel = $em->getRepository('AdminBundle:Carousel')->findAll();
            }
        ...
        $pagetemplate = 'AdminBundle:BuildPage:buildpage.html.twig';
    ...
    public function buildPageDetailsAction($slug, Request $request)
    {
        ...
        $page = $this->get('doctrine.orm.entity_manager')
            ->getRepository('AdminBundle:Page')
            ->findOneBy(array('slug' => $slug));

        $pageContents = $this->get('doctrine.orm.entity_manager')
            ->getRepository('AdminBundle:Page_Content')
            ->findBy(array('page' => $page));

        return $this->render('AdminBundle:BuildPage:pagedetails.html.twig', array(
            'page' => $page,
            'pageContents' => $pageContents
        ));
    }
    ...
    public function buildPageWithTemplateAction($slug = "home", $id = 0, $tab = '', Request $request)
    {
        ...
        $pContents = [];
        $footerContents = [];
        $template = 'AdminBundle:OLD:buildpagetemplated.html.twig';
    ...
    public function menuPrincipalAction($menuName)
    {
        ...
        return $this->render('AdminBundle:BuildContent:menu.html.twig', array(
            'menuName' => $menuName,
