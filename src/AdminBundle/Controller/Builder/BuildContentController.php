...
class BuildContentController extends Controller
{
    ...
    public function buildDefaultContentAction($selectposition, Request $request)
    {
        ...
        return $this->render('AdminBundle:BuildPage:buildcontents.html.twig', array(
            'page' => $page,
    ...
    public function buildContentAction($pageContent, $id = 0, Request $request)
    {
        ...
        switch ($pageContent->getContent()->getType()) {
            case "Image":
                return $this->render('AdminBundle:BuildContent:image.html.twig', array(
            ...
            case "MainMenu":
                ...
                break;
            case "Content":
                return $this->render('AdminBundle:BuildContent:content.html.twig', array(
                    'pageContent' => $pageContent
                ));
                break;
            case "Menu":
            ...
            default: //Text
                return $this->render('AdminBundle:BuildContent:text.html.twig', array(
                    'pageContent' => $pageContent
                ));
        }
    }
